    ...
    <body>
        ...
        <div class="typical-section" >
            <div class="container" >
                ...
                <p>
                Admission for the new academic year commences in the month of April. As per the CBSE norm K1 children registering for the Academic Session 2023-24 will have to be 3+ years old by 31st March 2023. For all other grades, admission is granted on the basis of an interaction/assessment.
                </p>
                ...
                <ul>
                    ...
                    <li>Copy of Child’s Aadhar Card</li> 
                    <li>Parivar Pehchaan Patra (PPP)</li>
        ...
        <!--Social Media Links-->
                <div class="social d-flex justify-content-center">
                    ...
                    <a class="mx-2" href="https://www.instagram.com/gemsinternationalgurgaon/"><i class="fab fa-instagram-square"></i></a>
                    <a class="mx-2" href="https://www.linkedin.com/company/gems-international-school-gurgaon/"><i class="fab fa-linkedin-in"></i></a>
                </div>
            </div>
        </section>
        <!-- Footer-->
